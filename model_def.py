...
# The notable modification here is the `GPT.generate` function.
    ...
    def generate(
        ...
        while i < max_new_tokens:
            ...
            if validator is not None:
                try:
                    validator.register_new_token(idx_next.item())
                except Exception:
                    # Try again.
                    continue
            ...
            if interpreter is not None:
                interpreter.live_interpret(idx_next.item())
...
def get_model_and_config():
    ...
    config = GPTConfig(
        ...
        n_layer=consts.NUM_LAYER,
        n_head=consts.NUM_HEAD,
        n_embd=consts.NUM_EMBD,
